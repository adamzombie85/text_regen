...
const uiTranslations = {
    md: {
        ...
        statuses_tw: ["當咧調用台語腦...", "當咧搜揣台語用詞...", "當咧排除中語語法...", "當咧提煉、提煉、再提煉..."]
    },
    tw: {
        uiTitleMain: "文本分析助手", step1Text: "1. 輸入文本", step2Text: "2. 分析報告", step3Text: "3. AI 改寫文本",
        btnShowStats: "📊 統計專區", lblStatsTitle: "📊 網站數據統計", lblTotalVisitors: "累積造訪人次", lblRecentHistory: "最近分析動態",
        ...
        regen: "重做一遍", 
        statuses_md: ["當咧調用中語腦...", "當咧揣中語的詞...", "當咧調整中語句型...", "當咧提煉、提煉、再提煉..."],
        statuses_tw: ["當咧調用台語腦...", "當咧搜揣在地用詞...", "當咧排除中語語法...", "當咧提煉、提煉、再提煉..."]
    }
};
...
const modalTranslations = {
    md: [
        ...
        { 
            title: "2. 文本分析", 
            desc: "分析結果會將文章內的漢字依照「出現頻率」分組：<br>• <b>1-500名</b>：最基礎常用字。<br>• <b>501-1000名</b>：常用字。<br>• <b>常用字以外</b>：較難的字。<br>• <b>未登錄字</b>：系統暫無資料的字。<br><br>※ 標註 <b>⭐ 星星</b> 的字代表其為「教育部台語推薦用字」。" 
        },
    ...
    tw: [
        ...
        { 
            title: "2. 分析報告", 
            desc: "分析結果會將文章內的漢字照「出現頻率」來分組：<br>• <b>1-500名</b>：上基礎、定時會用著的字。<br>• <b>501-1000名</b>：定時會用著的字。<br>• <b>常用字以外</b>：較難的字。<br>• <b>未登錄字</b>：系統無資料的字。<br><br>※ 有標 <b>⭐ 星星</b> 的字代表是「教育部台語推薦用字」。" 
        },
